...
const DashboardLayout = () => {
  ...
  return (
    ...
    >
      ...
      >
        {!open && (
          <div className="absolute top-4 left-4 lg:top-6 lg:left-6 z-40">
            <button
              onClick={() => setOpen(true)}
              className="text-2xl text-gray-800 dark:text-gray-100 p-2 rounded-lg bg-white/30 dark:bg-slate-800/50 backdrop-blur-md shadow-sm hover:bg-white/50 dark:hover:bg-slate-700/60 transition-all"
              title="Menüyü Aç"
            >
              ☰
            </button>
        ...
        <main className={`flex-1 px-7 lg:px-16 pt-5 md:pt-5 lg:pt-0 ${open ? 'lg:pt-5' : 'lg:pt-8'} pb-14 lg:pb-0 `}>
